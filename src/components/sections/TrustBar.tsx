...
import { getContent, defaultTrustBar } from "@/lib/site-content";

const icons = [Wrench, ShieldCheck, Sparkles, Building2, MessageCircle];

export async function TrustBar() {
  const content = await getContent("trustBar", defaultTrustBar);
